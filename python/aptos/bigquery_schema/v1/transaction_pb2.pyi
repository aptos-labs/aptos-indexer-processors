...
class Transaction(_message.Message):
    __slots__ = ["version", "block_height", "hash", "type", "payload", "state_change_hash", "event_root_hash", "state_checkpoint_hash", "gas_used", "success", "vm_status", "accumulator_root_hash", "num_events", "num_write_set_changes", "epoch", "inserted_at"]
