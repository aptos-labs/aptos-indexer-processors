...
class Transaction(_message.Message):
    __slots__ = ["accumulator_root_hash", "block_height", "epoch", "event_root_hash", "gas_used", "hash", "inserted_at", "num_events", "num_write_set_changes", "payload", "state_change_hash", "state_checkpoint_hash", "success", "type", "version", "vm_status"]
