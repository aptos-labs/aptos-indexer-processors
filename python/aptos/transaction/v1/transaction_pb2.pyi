...
class Transaction(_message.Message):
    __slots__ = ["timestamp", "version", "info", "epoch", "block_height", "type", "block_metadata", "genesis", "state_checkpoint", "user"]
...
class BlockMetadataTransaction(_message.Message):
    __slots__ = ["id", "round", "events", "previous_block_votes_bitvec", "proposer", "failed_proposer_indices"]
...
class TransactionInfo(_message.Message):
    __slots__ = ["hash", "state_change_hash", "event_root_hash", "state_checkpoint_hash", "gas_used", "success", "vm_status", "accumulator_root_hash", "changes"]
...
class UserTransactionRequest(_message.Message):
    __slots__ = ["sender", "sequence_number", "max_gas_amount", "gas_unit_price", "expiration_timestamp_secs", "payload", "signature"]
...
class WriteSetChange(_message.Message):
    __slots__ = ["type", "delete_module", "delete_resource", "delete_table_item", "write_module", "write_resource", "write_table_item"]
...
class TransactionPayload(_message.Message):
    __slots__ = ["type", "entry_function_payload", "script_payload", "module_bundle_payload", "write_set_payload", "multisig_payload"]
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
...
class MoveType(_message.Message):
    __slots__ = ["type", "vector", "struct", "generic_type_param_index", "reference", "unparsable"]
...
class Signature(_message.Message):
    __slots__ = ["type", "ed25519", "multi_ed25519", "multi_agent", "fee_payer"]
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
    ...
    def __init__(self, type: _Optional[_Union[Signature.Type, str]] = ..., ed25519: _Optional[_Union[Ed25519Signature, _Mapping]] = ..., multi_ed25519: _Optional[_Union[MultiEd25519Signature, _Mapping]] = ..., multi_agent: _Optional[_Union[MultiAgentSignature, _Mapping]] = ..., fee_payer: _Optional[_Union[FeePayerSignature, _Mapping]] = ...) -> None: ...
...
class FeePayerSignature(_message.Message):
    __slots__ = ["sender", "secondary_signer_addresses", "secondary_signers", "fee_payer_address", "fee_payer_signer"]
    SENDER_FIELD_NUMBER: _ClassVar[int]
    SECONDARY_SIGNER_ADDRESSES_FIELD_NUMBER: _ClassVar[int]
    SECONDARY_SIGNERS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, sender: _Optional[_Union[AccountSignature, _Mapping]] = ..., secondary_signer_addresses: _Optional[_Iterable[str]] = ..., secondary_signers: _Optional[_Iterable[_Union[AccountSignature, _Mapping]]] = ..., fee_payer_address: _Optional[str] = ..., fee_payer_signer: _Optional[_Union[AccountSignature, _Mapping]] = ...) -> None: ...

class AccountSignature(_message.Message):
    __slots__ = ["type", "ed25519", "multi_ed25519"]
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
