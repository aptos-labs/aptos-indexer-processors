...
class FeePayerSignature(_message.Message):
    __slots__ = ["fee_payer_address", "fee_payer_signer", "secondary_signer_addresses", "secondary_signers", "sender"]
...
class Signature(_message.Message):
    __slots__ = ["ed25519", "fee_payer", "multi_agent", "multi_ed25519", "type"]
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
    ED25519_FIELD_NUMBER: _ClassVar[int]
