...
export class TransactionsOutput extends jspb.Message {
  ...
  setTransactionsList(value: Array<TransactionOutput>): void;
...
export class TransactionOutput extends jspb.Message {
  getEncodedProtoData(): Uint8Array | string;
  getEncodedProtoData_asU8(): Uint8Array;
  getEncodedProtoData_asB64(): string;
  setEncodedProtoData(value: Uint8Array | string): void;
...
export namespace TransactionOutput {
  export type AsObject = {
    encodedProtoData: Uint8Array | string,
    version: number,
...
export class StreamStatus extends jspb.Message {
  getType(): StreamStatus.StatusTypeMap[keyof StreamStatus.StatusTypeMap];
  setType(value: StreamStatus.StatusTypeMap[keyof StreamStatus.StatusTypeMap]): void;
  ...
  setEndVersion(value: number): void;
...
export namespace StreamStatus {
  export type AsObject = {
    type: StreamStatus.StatusTypeMap[keyof StreamStatus.StatusTypeMap],
    startVersion: number,
    endVersion: number,
  }
...
export class RawDatastreamResponse extends jspb.Message {
  ...
  setData(value?: TransactionsOutput): void;
