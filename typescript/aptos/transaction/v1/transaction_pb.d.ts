...
// file: aptos/transaction/v1/transaction.proto
...
export class Transaction extends jspb.Message { 
    ...
    getVersion(): string;
    setVersion(value: string): Transaction;
    ...
    getEpoch(): string;
    setEpoch(value: string): Transaction;
    getBlockHeight(): string;
    setBlockHeight(value: string): Transaction;
...
export class BlockMetadataTransaction extends jspb.Message { 
    ...
    getRound(): string;
    setRound(value: string): BlockMetadataTransaction;
...
export class Event extends jspb.Message { 
    ...
    setSequenceNumber(value: string): Event;
...
export class TransactionInfo extends jspb.Message { 
    ...
    getGasUsed(): string;
    setGasUsed(value: string): TransactionInfo;
    getSuccess(): boolean;
...
export class EventKey extends jspb.Message { 
    getCreationNumber(): string;
    setCreationNumber(value: string): EventKey;
...
export class UserTransactionRequest extends jspb.Message { 
    ...
    getSequenceNumber(): string;
    setSequenceNumber(value: string): UserTransactionRequest;
    getMaxGasAmount(): string;
    setMaxGasAmount(value: string): UserTransactionRequest;
    getGasUnitPrice(): string;
    setGasUnitPrice(value: string): UserTransactionRequest;
