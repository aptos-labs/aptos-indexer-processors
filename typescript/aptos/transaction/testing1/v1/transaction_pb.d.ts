...
export class Block extends jspb.Message {
  ...
  setTimestamp(value?: aptos_util_timestamp_timestamp_pb.Timestamp): void;
...
export class Transaction extends jspb.Message {
  ...
  setInfo(value?: TransactionInfo): void;
  ...
  getType(): Transaction.TransactionTypeMap[keyof Transaction.TransactionTypeMap];
  setType(value: Transaction.TransactionTypeMap[keyof Transaction.TransactionTypeMap]): void;

  hasBlockMetadata(): boolean;
  clearBlockMetadata(): void;
  getBlockMetadata(): BlockMetadataTransaction | undefined;
  setBlockMetadata(value?: BlockMetadataTransaction): void;

  hasGenesis(): boolean;
  clearGenesis(): void;
  getGenesis(): GenesisTransaction | undefined;
  setGenesis(value?: GenesisTransaction): void;

  hasStateCheckpoint(): boolean;
  clearStateCheckpoint(): void;
  getStateCheckpoint(): StateCheckpointTransaction | undefined;
  setStateCheckpoint(value?: StateCheckpointTransaction): void;

  hasUser(): boolean;
  clearUser(): void;
  getUser(): UserTransaction | undefined;
  setUser(value?: UserTransaction): void;
...
export namespace Transaction {
  export type AsObject = {
    ...
    epoch: number,
    blockHeight: number,
    type: Transaction.TransactionTypeMap[keyof Transaction.TransactionTypeMap],
...
export class BlockMetadataTransaction extends jspb.Message {
  ...
  setPreviousBlockVotesBitvec(value: Uint8Array | string): void;
  ...
  setFailedProposerIndicesList(value: Array<number>): void;
...
export class GenesisTransaction extends jspb.Message {
  ...
  setPayload(value?: WriteSet): void;
...
export class UserTransaction extends jspb.Message {
  ...
  setRequest(value?: UserTransactionRequest): void;
...
export class Event extends jspb.Message {
  ...
  setType(value?: MoveType): void;

  getTypeStr(): string;
  setTypeStr(value: string): void;
...
export class TransactionInfo extends jspb.Message {
  ...
  setStateChangeHash(value: Uint8Array | string): void;
  ...
  setStateCheckpointHash(value: Uint8Array | string): void;
  ...
  setAccumulatorRootHash(value: Uint8Array | string): void;

  clearChangesList(): void;
  getChangesList(): Array<WriteSetChange>;
  setChangesList(value: Array<WriteSetChange>): void;
...
export class EventKey extends jspb.Message {
  ...
  setCreationNumber(value: number): void;
...
export class UserTransactionRequest extends jspb.Message {
  ...
  setExpirationTimestampSecs(value?: aptos_util_timestamp_timestamp_pb.Timestamp): void;

  hasPayload(): boolean;
  clearPayload(): void;
  getPayload(): TransactionPayload | undefined;
  setPayload(value?: TransactionPayload): void;
...
export class WriteSet extends jspb.Message {
  getWriteSetType(): WriteSet.WriteSetTypeMap[keyof WriteSet.WriteSetTypeMap];
  setWriteSetType(value: WriteSet.WriteSetTypeMap[keyof WriteSet.WriteSetTypeMap]): void;

  hasScriptWriteSet(): boolean;
  clearScriptWriteSet(): void;
  getScriptWriteSet(): ScriptWriteSet | undefined;
  setScriptWriteSet(value?: ScriptWriteSet): void;

  hasDirectWriteSet(): boolean;
  clearDirectWriteSet(): void;
  getDirectWriteSet(): DirectWriteSet | undefined;
  setDirectWriteSet(value?: DirectWriteSet): void;
...
export class ScriptWriteSet extends jspb.Message {
  getExecuteAs(): string;
  setExecuteAs(value: string): void;

  hasScript(): boolean;
  clearScript(): void;
  getScript(): ScriptPayload | undefined;
  setScript(value?: ScriptPayload): void;
...
export class DirectWriteSet extends jspb.Message {
  ...
  setWriteSetChangeList(value: Array<WriteSetChange>): void;
...
export namespace WriteSetChange {
  export type AsObject = {
    type: WriteSetChange.TypeMap[keyof WriteSetChange.TypeMap],
...
export class DeleteModule extends jspb.Message {
  ...
  setStateKeyHash(value: Uint8Array | string): void;

  hasModule(): boolean;
  clearModule(): void;
  getModule(): MoveModuleId | undefined;
  setModule(value?: MoveModuleId): void;
...
export class DeleteResource extends jspb.Message {
  ...
  setType(value?: MoveStructTag): void;
...
export class DeleteTableItem extends jspb.Message {
  ...
  setData(value?: DeleteTableData): void;
...
export class WriteModule extends jspb.Message {
  ...
  setData(value?: MoveModuleBytecode): void;
...
export class WriteTableItem extends jspb.Message {
  ...
  setData(value?: WriteTableData): void;
...
export namespace TransactionPayload {
  export type AsObject = {
    type: TransactionPayload.TypeMap[keyof TransactionPayload.TypeMap],
...
export class EntryFunctionPayload extends jspb.Message {
  ...
  setFunction(value?: EntryFunctionId): void;

  clearTypeArgumentsList(): void;
  getTypeArgumentsList(): Array<MoveType>;
  setTypeArgumentsList(value: Array<MoveType>): void;
  ...
  setEntryFunctionIdStr(value: string): void;
...
export class MoveScriptBytecode extends jspb.Message {
  ...
  setAbi(value?: MoveFunction): void;
...
export class ScriptPayload extends jspb.Message {
  ...
  setCode(value?: MoveScriptBytecode): void;
...
export class MultisigPayload extends jspb.Message {
  ...
  setTransactionPayload(value?: MultisigTransactionPayload): void;
...
export class MultisigTransactionPayload extends jspb.Message {
  getType(): MultisigTransactionPayload.TypeMap[keyof MultisigTransactionPayload.TypeMap];
  setType(value: MultisigTransactionPayload.TypeMap[keyof MultisigTransactionPayload.TypeMap]): void;
...
export namespace MultisigTransactionPayload {
  export type AsObject = {
    type: MultisigTransactionPayload.TypeMap[keyof MultisigTransactionPayload.TypeMap],
    entryFunctionPayload?: EntryFunctionPayload.AsObject,
  }
...
export class ModuleBundlePayload extends jspb.Message {
  ...
  setModulesList(value: Array<MoveModuleBytecode>): void;
...
export class MoveModule extends jspb.Message {
  ...
  setFriendsList(value: Array<MoveModuleId>): void;
...
export class MoveFunction extends jspb.Message {
  ...
  getVisibility(): MoveFunction.VisibilityMap[keyof MoveFunction.VisibilityMap];
  setVisibility(value: MoveFunction.VisibilityMap[keyof MoveFunction.VisibilityMap]): void;

  getIsEntry(): boolean;
  setIsEntry(value: boolean): void;

  clearGenericTypeParamsList(): void;
  getGenericTypeParamsList(): Array<MoveFunctionGenericTypeParam>;
  setGenericTypeParamsList(value: Array<MoveFunctionGenericTypeParam>): void;
...
export namespace MoveFunction {
  export type AsObject = {
    name: string,
    visibility: MoveFunction.VisibilityMap[keyof MoveFunction.VisibilityMap],
    isEntry: boolean,
    genericTypeParamsList: Array<MoveFunctionGenericTypeParam.AsObject>,
    paramsList: Array<MoveType.AsObject>,
    returnList: Array<MoveType.AsObject>,
  }
...
export class MoveStruct extends jspb.Message {
  ...
  getAbilitiesList(): Array<MoveAbilityMap[keyof MoveAbilityMap]>;
  setAbilitiesList(value: Array<MoveAbilityMap[keyof MoveAbilityMap]>): void;
  addAbilities(value: MoveAbilityMap[keyof MoveAbilityMap], index?: number): MoveAbilityMap[keyof MoveAbilityMap];

  clearGenericTypeParamsList(): void;
  getGenericTypeParamsList(): Array<MoveStructGenericTypeParam>;
  setGenericTypeParamsList(value: Array<MoveStructGenericTypeParam>): void;
  ...
  setFieldsList(value: Array<MoveStructField>): void;
...
export namespace MoveStruct {
  export type AsObject = {
    name: string,
    isNative: boolean,
    abilitiesList: Array<MoveAbilityMap[keyof MoveAbilityMap]>,
...
export class MoveStructGenericTypeParam extends jspb.Message {
  ...
  getConstraintsList(): Array<MoveAbilityMap[keyof MoveAbilityMap]>;
  setConstraintsList(value: Array<MoveAbilityMap[keyof MoveAbilityMap]>): void;
  addConstraints(value: MoveAbilityMap[keyof MoveAbilityMap], index?: number): MoveAbilityMap[keyof MoveAbilityMap];

  getIsPhantom(): boolean;
  setIsPhantom(value: boolean): void;
...
export namespace MoveStructGenericTypeParam {
  export type AsObject = {
    constraintsList: Array<MoveAbilityMap[keyof MoveAbilityMap]>,
    isPhantom: boolean,
  }
}
...
export class MoveType extends jspb.Message {
  getType(): MoveTypesMap[keyof MoveTypesMap];
  setType(value: MoveTypesMap[keyof MoveTypesMap]): void;

  hasVector(): boolean;
  clearVector(): void;
  getVector(): MoveType | undefined;
  setVector(value?: MoveType): void;

  hasStruct(): boolean;
  clearStruct(): void;
  getStruct(): MoveStructTag | undefined;
  setStruct(value?: MoveStructTag): void;

  hasGenericTypeParamIndex(): boolean;
  clearGenericTypeParamIndex(): void;
  getGenericTypeParamIndex(): number;
  setGenericTypeParamIndex(value: number): void;

  hasReference(): boolean;
  clearReference(): void;
  getReference(): MoveType.ReferenceType | undefined;
  setReference(value?: MoveType.ReferenceType): void;

  hasUnparsable(): boolean;
  clearUnparsable(): void;
  getUnparsable(): string;
  setUnparsable(value: string): void;
...
export namespace MoveType {
  export type AsObject = {
    type: MoveTypesMap[keyof MoveTypesMap],
...
export class MoveStructTag extends jspb.Message {
  ...
  setGenericTypeParamsList(value: Array<MoveType>): void;
...
export class Signature extends jspb.Message {
  getType(): Signature.TypeMap[keyof Signature.TypeMap];
  setType(value: Signature.TypeMap[keyof Signature.TypeMap]): void;

  hasEd25519(): boolean;
  clearEd25519(): void;
  getEd25519(): Ed25519Signature | undefined;
  setEd25519(value?: Ed25519Signature): void;

  hasMultiEd25519(): boolean;
  clearMultiEd25519(): void;
  getMultiEd25519(): MultiEd25519Signature | undefined;
  setMultiEd25519(value?: MultiEd25519Signature): void;

  hasMultiAgent(): boolean;
  clearMultiAgent(): void;
  getMultiAgent(): MultiAgentSignature | undefined;
  setMultiAgent(value?: MultiAgentSignature): void;
...
export namespace Signature {
  export type AsObject = {
    type: Signature.TypeMap[keyof Signature.TypeMap],
...
export class MultiEd25519Signature extends jspb.Message {
  ...
  setPublicKeyIndicesList(value: Array<number>): void;
...
export class MultiAgentSignature extends jspb.Message {
  ...
  setSender(value?: AccountSignature): void;

  clearSecondarySignerAddressesList(): void;
  getSecondarySignerAddressesList(): Array<string>;
  setSecondarySignerAddressesList(value: Array<string>): void;
  ...
  setSecondarySignersList(value: Array<AccountSignature>): void;
...
export class AccountSignature extends jspb.Message {
  getType(): AccountSignature.TypeMap[keyof AccountSignature.TypeMap];
  setType(value: AccountSignature.TypeMap[keyof AccountSignature.TypeMap]): void;
...
export namespace AccountSignature {
  export type AsObject = {
    type: AccountSignature.TypeMap[keyof AccountSignature.TypeMap],
    ed25519?: Ed25519Signature.AsObject,
    multiEd25519?: MultiEd25519Signature.AsObject,
  }
...
export const MoveTypes: MoveTypesMap;

export interface MoveAbilityMap {
...
export const MoveAbility: MoveAbilityMap;
