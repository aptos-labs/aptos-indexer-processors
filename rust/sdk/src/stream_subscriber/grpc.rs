...
use super::{ChannelHandle, StreamSubscriberTrait, TransactionsPBResponse};
use crate::{
    counters::{
...
pub struct GrpcStreamSubscriber {
    config: GrpcStreamSubscriberConfig,

    /// The name of the processor, likely originating from processor.name().
    processor_name: String,

    /// The transaction version to start streaming from.
