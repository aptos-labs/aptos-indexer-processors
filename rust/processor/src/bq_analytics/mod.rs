...
use crate::{
    bq_analytics::generic_parquet_processor::{
        ...
        ParquetHandler as GenericParquetHandler, ParquetProcessingState,
    },
    ...
    for<'a> &'a [ParquetType]: RecordWriter<ParquetType>,
{
    ...
    tokio::spawn(async move {
        ...
        loop {
            ...
            // info!("now.duration_since(last_upload_time): {:?} and upload_interval {:?}", now.duration_since(last_upload_time), upload_interval);
