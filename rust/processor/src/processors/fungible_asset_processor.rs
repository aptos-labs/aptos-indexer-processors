...
async fn insert_to_db(
    ...
    let faa = db_writer.send_in_chunks("fungible_asset_activities", fungible_asset_activities);
    let fam = db_writer.send_in_chunks("fungible_asset_metadata", fungible_asset_metadata);
    let fab = db_writer.send_in_chunks("fungible_asset_balances", fungible_asset_balances);
...
impl crate::db_writer::DbExecutable for Vec<FungibleAssetActivity> {
    async fn execute_query(
        ...
        let query = diesel::insert_into(schema::fungible_asset_activities::table)
            .values(self)
...
impl crate::db_writer::DbExecutable for Vec<FungibleAssetMetadataModel> {
    async fn execute_query(
        ...
        let query = diesel::insert_into(schema::fungible_asset_metadata::table)
            .values(self)
...
impl crate::db_writer::DbExecutable for Vec<FungibleAssetBalance> {
    async fn execute_query(
        ...
        let query = diesel::insert_into(schema::fungible_asset_balances::table)
            .values(self)
...
impl crate::db_writer::DbExecutable for Vec<CurrentFungibleAssetBalance> {
    async fn execute_query(
        ...
        let query = diesel::insert_into(schema::current_fungible_asset_balances::table)
            .values(self)
