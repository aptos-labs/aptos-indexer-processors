...
pub struct TokenV2ProcessorLight {
    connection_pool: PgDbPool,
}

impl TokenV2ProcessorLight {
    pub fn new(connection_pool: PgDbPool) -> Self {
        Self { connection_pool }
    }
}

impl Debug for TokenV2ProcessorLight {
...
#[async_trait]
impl ProcessorTrait for TokenV2ProcessorLight {
    fn name(&self) -> &'static str {
        ProcessorName::TokenV2ProcessorLight.into()
    }
        ...
        let txn_data = match txn.txn_data.as_ref() {
            ...
            None => {
                PROCESSOR_UNKNOWN_TYPE_COUNT
                    .with_label_values(&["TokenV2ProcessorLight"])
                    .inc();
                tracing::warn!(
            ...
            for (index, wsc) in transaction_info.changes.iter().enumerate() {
                ...
                match wsc.change.as_ref().unwrap() {
                    Change::WriteTableItem(table_item) => {
                        ...
                        if let Some((_, current_token_ownership)) =
                    ...
                    Change::WriteResource(resource) => {
                        ...
                        if let Some((_, current_nft_ownership)) =
                        ...
                        if let Some((_, current_ft_ownership)) =
