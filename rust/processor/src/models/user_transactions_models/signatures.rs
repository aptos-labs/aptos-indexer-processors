...
impl Signature {
    ...
    fn parse_single_sender(
        ...
        match signature.signature.as_ref() {
            ...
            // Some(AccountSignatureEnum::MultiEd25519(s)) => Self::parse_multi_ed25519_signature(s, sender, transaction_version, transaction_block_height, is_sender_primary, multi_agent_index, override_address),
            _ => vec![],
        }
    }
}
