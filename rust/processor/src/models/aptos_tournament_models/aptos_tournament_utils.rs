...
pub struct TournamentState {
    ...
    #[serde(deserialize_with = "deserialize_from_string")]
    pub tournament_start_timestamp_sec: i64,
}
...
pub struct Round {
    ...
    #[serde(deserialize_with = "deserialize_from_string")]
    pub round_end_timestamp_sec: i64,
}
...
pub enum AptosTournamentResource {
    ...
    MainPageTournament(MainPageTournament),
...
impl AptosTournamentResource {
    pub fn is_resource_supported(contract_addr: &str, data_type: &str) -> bool {
        ...
        [
            ...
            format!("{}::tournament_manager::MainPageTournament", contract_addr),
    ...
    pub fn from_resource(
        ...
        match data_type.clone() {
            ...
            x if x == format!("{}::tournament_manager::MainPageTournament", contract_addr) => {
                serde_json::from_value(data.clone())
                    .map(|inner| Some(Self::MainPageTournament(inner)))
            },
