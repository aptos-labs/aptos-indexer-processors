...
use crate::{
    ...
    db::{
        ...
        postgres::models::{
            ...
            token_v2_models::v2_token_ownerships::CurrentTokenOwnershipV2,
        },
    },
...
// use parquet_derive::ParquetRecordWriter;
// use serde::{Deserialize, Serialize};
// use  crate::db::common::models::token_v2_models::raw_v2_token_ownerships::TokenOwnershipV2Convertible;
// use crate::db::common::models::token_v2_models::raw_v2_token_ownerships::RawTokenOwnershipV2;
...
//             token_properties_mutated_v1: raw_item.token_properties_mutated_v1.map(|v| v.to_string()),
